...
public class NewsRepositoryImpl implements NewsRepository {
    ...
    @Override
    public List<News> findByCategory(News.Category category) {
        return newsJpaRepository.findByCategory(category, Pageable.unpaged()).getContent();
    }
    
    @Override
    public Page<News> findByCategory(News.Category category, Pageable pageable) {
    ...
    @Override
    public Page<News> findByCategoryOrderByPublishedAtDesc(News.Category category, Pageable pageable) {
    ...
    @Override
    public Long countByCategory(News.Category category) {
